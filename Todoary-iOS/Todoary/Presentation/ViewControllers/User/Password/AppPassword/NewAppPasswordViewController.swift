...
class NewAppPasswordViewController : BaseViewController {
    ...
    override func initialize() {
        ...
        mainView.numBtn1.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn1.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn1.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn2.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn2.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn2.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn3.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn3.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn3.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn4.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn4.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn4.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn5.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn5.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn5.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn6.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn6.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn6.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn7.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn7.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn7.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn8.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn8.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn8.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn9.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn9.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn9.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.numBtn0.addTarget(self, action: #selector(firstPwInput), for: .touchUpInside)
        mainView.numBtn0.addTarget(self, action: #selector(secondPwInput), for: .touchUpInside)
        mainView.numBtn0.addTarget(self, action: #selector(wrongPwInput), for: .touchUpInside)
        
        mainView.deleteBtn.addTarget(self, action: #selector(deletBtndidtab), for: .touchUpInside)
        mainView.deleteBtn.addTarget(self, action: #selector(deletBtndidtab2), for: .touchUpInside)
    }
